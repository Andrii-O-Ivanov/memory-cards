...
У проєкті налаштовано автоматичну генерацію документації за допомогою **JSDoc** та шаблону **better-docs**. Задокументовано ключові архітектурні вузли: UI-компоненти, кастомні хуки та глобальний стан (Redux).

🎥 **[Відео-демонстрація згенерованої документації](https://drive.google.com/file/d/1zicmLzaE7mcGu-jZy9Ej-fEE2nk9qG_K/view?usp=drive_link)**

## 🎨 Storybook

Для ізольованого тестування UI-компонентів у проєкт інтегровано **Storybook**. Це дозволяє перевіряти різні стани інтерфейсу без запуску всієї логіки гри.

Описано наступні компоненти:
* **Card** (базовий): стани закритої/відкритої картки та знайденої пари.
* **Modal** (комплексний): варіації вікна перемоги та інформаційного повідомлення.

🎥 **[Відео-демонстрація роботи Storybook](https://drive.google.com/file/d/15X_EUnBq_5jJvD_3SoZmONmBC9-UiIxE/view?usp=sharing)**
